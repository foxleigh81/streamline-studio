 ...
 * This is applied to all API routes and form submissions.
 *
 ...
 * - Supports X-Forwarded-Host when TRUSTED_PROXY=true
 *
 * GET, HEAD, OPTIONS requests are allowed without CSRF check.
 *
