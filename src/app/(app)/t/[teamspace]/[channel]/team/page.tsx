 ...
 *
 * Allows channel owners to manage team members:
 * - View all members
 * - Change member roles
 * - Remove members
 * - Invite new members
...
export default function TeamPage() {
  ...
  // Get current channel to check user role
  const { data: channel } = trpc.channel.getBySlugSimple.useQuery({
    slug: channelSlug,
  });
  ...
  const isLoading = isLoadingMembers || !channel;
      ...
      <div className={styles.header}>
        <div>
          ...
          <p className={styles.subtitle}>
            Manage team members and their access to this channel
          </p>
        </div>
      </div>
          ...
          {!isOwner && (
            <section className={styles.section}>
              <div className={styles.infoMessage}>
                <p>Team management is available to channel owners.</p>
              </div>
            </section>
          )}
        </div>
